...
router.post('/', restrictAdminCreation('daily logs', ['PM', 'FOREMAN', 'WORKER', 'SUPER_ADMIN']), upload.array('photos', 5), createDailyLog);
router.patch('/:id', authorize('SUPER_ADMIN', 'COMPANY_OWNER', 'PM', 'FOREMAN', 'WORKER'), upload.array('photos', 5), updateDailyLog);
router.post('/:id/verify', authorize('SUPER_ADMIN', 'COMPANY_OWNER'), verifyDailyLog);
