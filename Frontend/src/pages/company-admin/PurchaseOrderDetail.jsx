...
const PurchaseOrderDetail = ({ isPublic = false }) => {
    ...
    const handleDownloadPDF = async (poData = null) => {
        try {
            ...
            const companyName = data.companyId?.name || data.projectId?.companyId?.name || user?.companyName || "KT Construct";
            const companyEmail = data.companyId?.email || data.projectId?.companyId?.email || user?.email || "procurement@ktconstruct.com";
            ...
            doc.text("Generated by KT Construct Software", pageWidth / 2, 285, { align: 'center' });
    ...
    const handleSendPO = async () => {
        ...
        const formatEmailDate = (value) => {
            ...
            if (!dateValue || Number.isNaN(dateValue.getTime())) return 'N/A';
        ...
        try {
            ...
            const finalCompanyName = (typeof fetchedCompany === 'object' ? fetchedCompany?.name : null) || user?.companyName || "KT Construct";
            ...
            // Public Logo URL (Swap the link below with your hosted KT Construct Logo)
            ...
            const formattedTotalAmount = po.totalAmount !== undefined && po.totalAmount !== null
            ...
            const templateParams = {
                ...
                deliveryDate: formatEmailDate(po.expectedDeliveryDate),
                issueDate: formatEmailDate(po.createdAt),
                date: formatEmailDate(po.createdAt),
